...
const CompleteBooking = () => {
  ...
  // ✅ **Filter only Processed bookings**
  const ProcessedBookings = BOOKINGS_DATA.filter(
    (booking) => booking.status === "Processed"
  );

  // ✅ **Search functionality**
  const filteredBookings = searchQuery.trim()
    ? ProcessedBookings.filter((booking) =>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex items-center gap-2 mb-6">
        <div className="relative flex-1">
          <input
            type="text"
            placeholder="Search Processed bookings..."
            value={searchQuery}
